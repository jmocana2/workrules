...
const mockConvenios: Convenio[] = [
  ...
  },
  {
    ...
    url_pdf: 'https://boe.es/diario_boe/txt.php?id=BOE-A-2023-45678',
    estado: 'activo',
    visibilidad: 'publico',
  ...
  },
  {
    ...
    url_pdf: 'https://boe.es/diario_boe/txt.php?id=BOE-A-2023-56789',
    estado: 'activo',
    visibilidad: 'publico',
  ...
  },
  {
    ...
    ambito: 'empresa',
    codigo_regcon: 'BOE-A-2023-67890',
    url_pdf: 'https://boe.es/diario_boe/txt.php?id=BOE-A-2023-67890',
    estado: 'activo',
    visibilidad: 'publico',
  ...
  },
  {
    ...
    ambito: 'estatal',
    codigo_regcon: 'BOE-A-2023-78901',
    url_pdf: 'https://boe.es/diario_boe/txt.php?id=BOE-A-2023-78901',
    estado: 'activo',
    visibilidad: 'publico',
  ...
  },
  {
    ...
    ambito: 'provincial',
    codigo_regcon: 'BOE-A-2023-89012',
    url_pdf: 'https://boe.es/diario_boe/txt.php?id=BOE-A-2023-89012',
    estado: 'activo',
    visibilidad: 'publico',
          ...
          <div className="rounded-lg border border-border bg-muted/30 p-4">
            ...
            <dl className="space-y-1 text-xs">
              ...
              <div className="flex gap-2">
                ...
                <dd className="font-mono">{selectedConvenio.codigo_regcon}</dd>
              </div>
            </dl>
          </div>
        )}
