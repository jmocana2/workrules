...
CREATE TABLE convenios (
    ...
    estado VARCHAR(50) DEFAULT 'activo' CHECK (estado IN ('activo', 'activo_sin_perfil', 'derogado', 'pendiente', 'archivado', 'procesando', 'error', 'rechazado')),
...
-- Bucket de Storage para PDFs de convenios
